...
import net.mctower.npc.BServer;
import net.mctower.npc.BWorld;
import net.mctower.npc.NPCEntity;
import net.mctower.npc.NPCNetworkManager;
...
public class NPCManager {
	...
	private final static HashMap<String, NPC>	npcs	= new HashMap<String, NPC>();
	...
	public static String getNPCIdFromEntity(final org.bukkit.entity.Entity e) {
	...
	public NPC spawnHumanNPC(final String name, final Location l) {
		...
		if (name.length()>16) realName=name.substring(0, 16);
		String id = realName;
		while (npcs.containsKey(id)) {
			i++;
			id = realName + i;
		}
		return spawnHumanNPC(realName, l, id);
	}
